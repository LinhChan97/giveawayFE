...
import { TestHealthCheckComponent } from 'app/admin/health/health.component';
import { TestHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('TestHealthCheckComponent', () => {
    let comp: TestHealthCheckComponent;
    let fixture: ComponentFixture<TestHealthCheckComponent>;
    let service: TestHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [GiveawayTestModule],
        declarations: [TestHealthCheckComponent]
      })
        .overrideTemplate(TestHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(TestHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(TestHealthService);
    });

...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: TestLoginModalComponent;
    let fixture: ComponentFixture<TestLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [TestLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(TestLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(TestLoginModalComponent);
